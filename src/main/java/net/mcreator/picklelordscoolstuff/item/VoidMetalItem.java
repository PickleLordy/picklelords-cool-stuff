...
public class VoidMetalItem extends PicklelordsCoolStuffModElements.ModElement {
	@ObjectHolder("picklelords_cool_stuff:void_metal")
	public static final Item block = null;
	public VoidMetalItem(PicklelordsCoolStuffModElements instance) {
		super(instance, 7);
	}

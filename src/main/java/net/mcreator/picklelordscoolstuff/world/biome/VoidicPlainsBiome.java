...
public class VoidicPlainsBiome extends PicklelordsCoolStuffModElements.ModElement {
	public static Biome biome;
	public VoidicPlainsBiome(PicklelordsCoolStuffModElements instance) {
		super(instance, 5);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("picklelords_cool_stuff:voidic_plains"));
			}
		}
	}
	@Override

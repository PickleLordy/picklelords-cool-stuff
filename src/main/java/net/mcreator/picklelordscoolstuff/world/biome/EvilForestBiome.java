...
public class EvilForestBiome extends PicklelordsCoolStuffModElements.ModElement {
	public static Biome biome;
	public EvilForestBiome(PicklelordsCoolStuffModElements instance) {
		super(instance, 6);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777216).setWaterColor(-16777216).setWaterFogColor(-16777216)
						.withSkyColor(-16777216).withFoliageColor(-10066330).withGrassColor(-13421773).build();
				...
				event.getRegistry().register(biome.setRegistryName("picklelords_cool_stuff:evil_forest"));
			}
		}
	}
	@Override

...
package net.mcreator.picklelordscoolstuff.world.dimension;
...
import net.mcreator.picklelordscoolstuff.item.VoidDimensionItem;
...
public class VoidDimensionDimension extends PicklelordsCoolStuffModElements.ModElement {
	@ObjectHolder("picklelords_cool_stuff:void_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public VoidDimensionDimension(PicklelordsCoolStuffModElements instance) {
		super(instance, 1);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("picklelords_cool_stuff:void_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					...
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("picklelords_cool_stuff:void_dimension")));
				} else {
					entity.func_242279_ag();
